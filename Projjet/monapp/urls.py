...
#CRUD Produit#
path('',ProduitListView.as_view(), name='produit-list'),#Principal Index de Produit
path('produit/<int:pk>/', ProduitDetailView.as_view(), name='produit-detail'),#Détail(page principale)
path('produit/ajouter/', ProduitCreateView.as_view(), name='produit-create'),#Ajouter(page principale)
path('produit/<int:pk>/modifier/', ProduitUpdateView.as_view(), name='produit-update'),#Modifier(page principale)
path('produit/<int:pk>/supprimer/',ProduitDeleteView.as_view(), name='produit-delete'),#Supprimer(page principale)

###
#CRUD Categorie

path('Categorie/',CategorieListView.as_view(), name='categorie-list'),#Principal(Index Categorie)
path('Categorie/categorie/<int:pk>/', CategorieDetailView.as_view(), name='categorie-detail'),#Détail(Categorie)
path('Categorie/categorie/ajouter/', CategorieCreateView.as_view(), name='categorie-create'),
path('Categorie/categorie/<int:pk>/modifier/', CategorieUpdateView.as_view(), name='categorie-update'),#Modifier(Categorie)
path('Categorie/categorie/<int:pk>/supprimer/',CategorieDeleteView.as_view(), name='categorie-delete'),#Supprimer(Categorie)
